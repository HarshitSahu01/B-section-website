  ...
  return (
    <div ref={ref} className="mt-12 mb-32 mx-44">
      <section className="flex flex-col justify-center items-center">
        <span id="creators" className="achieve-head mb-12 w-[20vw] rounded-xl px-2 py-3 text-center flex justify-center items-center text-4xl font-bold text-yellow-400">
          Creators
        </span>
