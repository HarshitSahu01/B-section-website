      ...
      <section className="mt-12 mb-32 mx-44 flex flex-col justify-center items-center">
        ...
        <main>
          ...
          >
            ...
            <div className="crea-1 w-[45vw] h-[20vh] lg:w-[20vw] lg:h-[40vh] rounded-full shadow-md shadow-yellow-200">
              <div className="img-1 lg:w-[20vw] lg:h-[42vh] w-[45vw] h-[21vh] rounded-full shadow-lg shadow-yellow-200 border-t-8 border-t-yellow-300 border-b-8 border-b-orange-300 border-l-4 border-l-yellow-300 border-r-4 border-r-orange-300 "></div>
              {/* <p>Creator 2</p> */}
            </div>
            <div className="crea-1 w-[45vw] h-[20vh] lg:w-[20vw] lg:h-[40vh] rounded-full shadow-md shadow-yellow-200">
              <div className="img-1 lg:w-[20vw] lg:h-[42vh] w-[45vw] h-[21vh] rounded-full shadow-lg shadow-yellow-200 border-t-8 border-t-yellow-300 border-b-8 border-b-orange-300 border-l-4 border-l-yellow-300 border-r-4 border-r-orange-300 "></div>
