            ...
            {navItems.map((item) => (
              <li key={item.name}>
                <Link
                  ...
                  className={`flex items-center h-full text-white transition duration-200 ease-in-out transform hover:scale-110 px-4 py-2 rounded-md ${
                    activeItem === item.path ? "border-b-4 border-orange-500" : ""
                  }`}
                >
                  {item.name}
                </Link>
